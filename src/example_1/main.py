...
def main():
    ...
    train_set = pd.read_csv('train.csv', dtype={'deg-malig':str})
    valid_set = pd.read_csv('validation.csv', dtype={'deg-malig':str})
    test_set = pd.read_csv('test.csv', dtype={'deg-malig':str})
    target = 'class'
